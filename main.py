...
def parse_args():
    ...
    parser.add_argument('--gradient_clipping', type=float, required=True, help='Gradient clipping value')
...
def main():
    args = parse_args()
    wandb.login()
    logger = WandbLogger(project="mlops_project_2", name="GIT_run")
    ...
    trainer = L.Trainer(
        ...
        devices=1,
        logger=logger,
        gradient_clip_val=hyperparams["gradient_clipping"],
    )
